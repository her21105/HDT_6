...
public class LHMap implements estructura {
	
	Map<categorizar,producto> listaUsuario = new LinkedHashMap<categorizar, producto>() ;
	Map<categorizar,String> listaProducto = new LinkedHashMap<categorizar, String>();
